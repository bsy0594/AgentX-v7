...
from agent import HyperparameterTunerAgent
...
class Executor(AgentExecutor):
    def __init__(self):
        self.agent = HyperparameterTunerAgent()
    ...
    async def execute(self, context: RequestContext, event_queue: EventQueue) -> None:
        ...
        try:
            ...
            print(f"[Tuner] Executor error: {e}")
            await updater.failed(new_agent_text_message(f"Hyperparameter Tuner agent failed: {e}"))
