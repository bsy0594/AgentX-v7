...
from agent import StackingAgent
...
class Executor(AgentExecutor):
    ...
    async def execute(self, context: RequestContext, event_queue: EventQueue) -> None:
        ...
        try:
            ...
            print(f"[Stacking] Executor error: {e}")
            await updater.failed(new_agent_text_message(f"Stacking agent failed: {e}"))
