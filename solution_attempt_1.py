...
submission_path = Path("C:/Users/PC4/AppData/Local/Temp/ml_agent_2xoebdeg/submission.csv")
...
pipe = Pipeline([("pre", pre), ("model", XGBClassifier(use_label_encoder=False, eval_metric='logloss'))])
pipe.fit(X_tr, y)
